...
$query = "SELECT * FROM cricketblog order by date desc";
...
<body>
	...
	<div class="container">
		...
		<h2><i class="fa fa-commenting"></i> Blog Posts </h2>

		<table class="table table-striped table-dark" data-page-size="4">
			<thead>
				<tr>
			...
			<?php while ($row = $statement->fetch()): ?>
				...
				<tbody>
					<tr>
						...
						<td><small><?= Date("F j\, Y\, g:i a - ", strtotime($row['date'])) ?><a href="edit.php?id=<?php echo $row['id'] ?>"><button type="button" class="btn btn-warning">Edit</button></a></small></td>
					</tr>	
				</tbody>
			<?php endwhile ?>
		</table>
		<hr>
		<!-- <li><a href="create.php"><button type="button" class="btn btn-info">Create Blog</button></a></li> -->
		<br>
		<br>
		<br>

		<h2><i class="fa fa-id-card-o"></i> Users Profile Pictures</h2>
...
<br>
		...
		<h2><i class="fa fa-graduation-cap"></i>ACA Graduates</h2>
